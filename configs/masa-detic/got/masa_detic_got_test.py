...
model = dict(
    ...
    tracker=dict(
        type='MasaTaoTracker', #TODO: Change to MasaLasotTracker
        init_score_thr=0.0001,
        obj_score_thr=0.0001,
        match_score_thr=0.5,
        memo_tracklet_frames=50, # initial was 10
        memo_momentum=0.8,
        with_cats=False,
        max_distance=-1,
        fps=1,
...
val_evaluator = dict(
    ann_file='data/got10k/annotations/got_coco_val.json',
    #ann_file='hard_tracks/hard_tracks_annotations_got.json',
    outfile_prefix='results/masa_results/masa-detic-release-detic-dets-got-test',
)
