...
class GotTETAMetric(BaseVideoMetric):
    ...
    default_prefix: Optional[str] = "got_teta_metric"
    ...
    def __init__(
        ...
        assert dataset_type in ["GotDataset"]
        if dataset_type == "GotDataset":
            from masa.datasets import GotDataset

            self.class_list = GotDataset.METAINFO["classes"]
