...
class SORTTracker(BaseTracker):
    ...
    def update_track(self, id: int, obj: Tuple[Tensor]) -> None:
        ...
        try:
            ...
            print()
            print(f"[Track {id}] Kalman update skipped due to LinAlgError: {e}")
            print(f"Track {id} mean: {self.tracks[id].mean}")
            print(f"Track {id} covariance: {self.tracks[id].covariance}")
    ...
    def track(self,
        ...
        if self.empty or bboxes.size(0) == 0:
            ...
            try:
                self.tracks, costs = self.motion.track(self.tracks, bbox_xyxy_to_cxcyah(bboxes))
