...
class MasaTrackLocalVisualizer(Visualizer):
    ...
    def _draw_instances(
        ...
        if "instances_ids" in instances:
            colors = [random_color(_id) for _id in instances.instances_ids]
        elif "instances_id" in instances:
            colors = [random_color(_id) for _id in instances.instances_id]
        else:
            raise ValueError("instances_id or instances_ids not in instances")

        #colors = [random_color(_id) for _id in instances.instances_ids] if "instances_ids" in instances else [random_color(_id) for _id in instances.instances_id]
